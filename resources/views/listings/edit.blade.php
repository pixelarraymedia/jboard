<x-layout>
    <x-card class="p-10 max-w-lg mx-auto mt-24">
      ...
      <form method="POST" action="/listings/{{$listing->id}}" enctype="multipart/form-data">
        @csrf
        {{-- lavarel method to PUT for edit --}}
        @method('PUT')
        ...
        <div class="mb-6">
          ...
          <input type="text" class="border border-gray-200 rounded p-2 w-full" name="tags"
            placeholder="Example: Laravel, Backend, Postgres, etc" value="{{$listing->company}}" />
        ...
        <div class="mb-6">
          ...
          <img
          class="w-48 mr-6 mb-6" src="{{asset('images/no-image.png')}}"
          alt=""
      />
